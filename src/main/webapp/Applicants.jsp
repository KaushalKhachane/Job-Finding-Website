...
<%@ page import="com.company.HRLogin"%>
...
<body>
	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
			<div class="navbar-nav">
				...
				<a class="nav-link" href="http://localhost:8081/CPP/HRLogin?name=3i+infotech&ps=12345">Back</a>
	...
	<div class="limiter">
		<div class="container-login100"
			...
			<div align="center">
				<span class="login100-form-title p-b-41"> Applicants </span>
			</div>
			<%
			try {
				String companyApplied = String.join("_", HRLogin.companyApplicants.toLowerCase().split(" ", 5));
				String query = "select s_name, s_phone, s_email, s_dob, s_qualification, s_expertise, s_experience from job."
				+ companyApplied + ";";
				...
				out.println("<br><table style='color:white'> <tr>");
				...
				out.println("<th><h3> Qualification </h3></th>");
				out.println("<th><h3> Expertise </h3></th>");
				out.println("<th><h3> Experience </h3></th>");
				out.println("<th><h3> Approve? </h3></th> </tr>");
				while (rs.next()) {
					out.println("<tr>");
					...
					out.println("<input type='hidden' name='comp_name' value='" + companyApplied + "'/>");
					out.println("<input type='hidden' name='app_name' value='" + rs.getString(1) + "'/>");
					out.println("<input type='hidden' name='app_email' value='" + rs.getString(3) + "'/>");
					out.println(
					"<td><input type='submit' name='approve' value='Approve' color='blue' background='yellow'/> </td> </tr>");
				}
				out.println("</table>");
			} catch (Exception e) {
				e.printStackTrace();
